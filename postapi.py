def PostHAEntity(Serial,UOM,UOMLong,fName,sName,EntityVal):
    ...
    with open('/data/options.json') as options_file:
        ...
        # API URL
        url = f"{httpurl_proto}://" + str(json_settings['Home_Assistant_IP']) + ":" + str(json_settings['Home_Assistant_PORT']) + "/api/states/sensor.solarkv2_" + Serial + '_' + sName
    ...
    try:
        ...
        if len(parsed_login_json['entity_id']) > 1:
            #print("Solark Login: " + ConsoleColor.OKGREEN + parsed_login_json + ConsoleColor.ENDC)
