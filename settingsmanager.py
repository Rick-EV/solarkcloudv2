...
def GetNewSettingsFromHAEntity(SolarkToken,Serial):
    global api_server
    ...
    try:
        ...
        if LastSettingsType ==  "Valid Battery Setting":
            PostSettingToSolark(SolarkToken,Serial,"Battery Settings")
        if LastSettingsType ==  "Valid SystemMode Setting":
            PostSettingToSolark(SolarkToken,Serial,"SystemMode Settings")            
...
def PostSettingToSolArk(Token,Serial,SettingsType):
